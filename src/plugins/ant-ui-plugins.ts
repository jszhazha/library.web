...
import { Button, Divider, Form, Input, Modal, Pagination, Row, Col, Checkbox, notification, Popover, Popconfirm, message, Menu, Dropdown, Select, Progress, DatePicker,InputNumber } from 'ant-design-vue'
...
export default class AntUiPlugins {
  static init(app: App<Element>): void {
    ...
    app.use(Progress).use(DatePicker).use(InputNumber)
