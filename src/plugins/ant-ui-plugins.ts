...
import { Button, Divider, Form, Input, Modal, Pagination, Row, Col, Checkbox, notification, Popover, Popconfirm, Tooltip, message, Menu, Dropdown, Select, Progress, DatePicker, InputNumber, Tag, Tree, Upload, Affix ,Layout} from 'ant-design-vue'
...
export default class AntUiPlugins {
  static init(app: App<Element>): void {
    ...
    app.use(Tree).use(Affix).use(Layout)
