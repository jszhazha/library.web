...
import { LoginRoutes, ResetPasswordRoute, SearchRoute } from './modules/frameRouter'
...
export const basicRoutes = [...LoginRoutes, ResetPasswordRoute, SearchRoute, IndexPage, RootRoute, NoFountPage]